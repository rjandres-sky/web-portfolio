...
function loopSeed() {
  ...
  for (let index = 1; index <= 18; index++) {
    ...
    //console.log((index + " " + locateHole-1 + " " + changeStartHole));
    ...
    if (locateHole == 8 || locateHole == 16 || locateHole == 24 || locateHole == 32) {
      ...
      HolesValue[locateHole - 1] += 1;
        console.log(locateHole - 1  + " " + HolesValue[locateHole - 1]);
      ...
      if ((changeStartHole % 16) == 0) {
        ...
        hole.innerHTML = index + startHole;
          console.log((locateHole - changeStartHole) - 1  + " ---"+ currentPlayer +"-- " + HolesValue[(locateHole - changeStartHole) - 1]);
